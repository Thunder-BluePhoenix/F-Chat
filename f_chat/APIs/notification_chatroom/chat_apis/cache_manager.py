# f_chat/APIs/notification_chatroom/chat_apis/cache_manager.py
...
def force_refresh_user_cache(user=None):
    ...
    try:
        ...
        from f_chat.APIs.notification_chatroom.chat_apis.status_manager import chat_status_manager
