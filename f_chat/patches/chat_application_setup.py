# f_chat/patches/chat_application_setup.py
...
def install_chat_application():
    ...
    try:
        ...
        try:
            from f_chat.f_chat import setup
...
def verify_installation():
    ...
    try:
        ...
        total_checks += 1
        try:
            api_method = frappe.get_attr("f_chat.APIs.notification_chatroom.chat_apis.chat_api.get_user_chat_rooms")
            if api_method:
