// f_chat/public/js/chat_error_handler.js
...
class ChatErrorHandler {
    ...
    handleTimestampMismatch(originalOptions, callback) {
        ...
        setTimeout(() => {
            if (originalOptions.method === 'f_chat.get_user_chat_status' || 
                originalOptions.method === 'f_chat.update_user_online_status') {
    ...
    handleReconnection() {
        ...
        this.makeApiCall({
            method: 'f_chat.update_user_online_status',
            args: { status: 'online' },
...
window.addEventListener('beforeunload', function() {
    if (typeof chatEnabled !== 'undefined' && chatEnabled) {
        ...
        if (navigator.sendBeacon) {
            ...
            formData.append('cmd', 'f_chat.update_user_online_status');
            formData.append('status', 'offline');
            navigator.sendBeacon('/api/method/f_chat.update_user_online_status', formData);
        }
    }
});
