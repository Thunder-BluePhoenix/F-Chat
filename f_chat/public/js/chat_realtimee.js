// File: f_chat/public/js/chat_realtime.js
        ...
        if ('Notification' in window && Notification.permission === 'granted') {
            const notification = new Notification(
                data.sender_name ? `${data.sender_name} in ${data.room_name}` : 'New Chat Message',
                {
                    ...
                    icon: '/assets/f_chat/images/chat-icon.png',
                    badge: '/assets/f_chat/images/chat-badge.png',
...
function playNotificationSound() {
    try {
        const audio = new Audio('/assets/f_chat/sounds/notification.mp3');
        audio.volume = 0.3;
        audio.play().catch(e => {
