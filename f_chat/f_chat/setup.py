# f_chat/APIs/notification_chatroom/setup.py
...
def validate_chat_installation():
    ...
    try:
        ...
        try:
            frappe.get_attr("f_chat.APIs.notification_chatroom.chat_apis.chat_api.get_user_chat_rooms")
